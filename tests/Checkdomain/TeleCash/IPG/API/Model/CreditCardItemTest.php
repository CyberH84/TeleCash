 ...
 */
class CreditCardItemTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testXMLGeneration(CreditCardData $creditCardData, $hostedDataId, $function, $declineHostedDataDuplicates)
    {
