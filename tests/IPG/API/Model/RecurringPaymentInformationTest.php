 ...
 */
class RecurringPaymentInformationTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testXMLGeneration($startDate, $installmentCount, $installmentFrequency, $installmentPeriod)
    {
